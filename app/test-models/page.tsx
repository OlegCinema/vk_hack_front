...
export default function TestModels() {
  ...
  const getResultFromModel = async () => {
    ...
    setResulted({
      categoryName: data.meta_class,
      shortDescription: data.shortDescription,
      tags: {
        popular: data?.tags?.popular,
        names: data?.tags?.names,
      },
